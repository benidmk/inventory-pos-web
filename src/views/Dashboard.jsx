  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setTotalAll(Number(ts?.total || 0));
        setProfitAll(Number(pf?.profit || 0));
      } catch (e) {
    ...
    <div className="grid lg:grid-cols-3 gap-4">
      ...
      <Card>
        ...
        <div className="text-xs text-gray-400 mt-1">
          {errorSummary ? (
            <span className="text-red-600">Error: {errorSummary}</span>
          ) : (
            "Semua transaksi hingga saat ini"
          )}
        </div>
      </Card>
